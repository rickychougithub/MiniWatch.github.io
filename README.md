...
<head>
    ...
    <script type="text/javascript">
       var _gaq = _gaq || [];
       _gaq.push(['_setAccount', 'G-PBZN8G468R']);
...
<body>
    <nav class="navbar navbar-light navbar-expand bg-light navigation-clean">
        <div class="container"><a class="navbar-brand" href="#">MiniWatch</a><button class="navbar-toggler" data-toggle="collapse" data-target="#navcol-1"></button>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-9 mx-auto">
                    <h1 class="mb-5">Welcome to MiniWatch.com</h1>
                </div>
                <div class="col-md-10 col-lg-8 col-xl-7 mx-auto">
                    <form>
                        <div class="form-row">
                            <div class="col-12 col-md-3"><button class="btn btn-primary btn-block btn-lg" type="submit">Shop NOW!</button></div>
                        </div>
                    </form>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="mx-auto features-icons-item mb-5 mb-lg-0 mb-lg-3">
                        <div class="d-flex features-icons-icon"><i class="icon-heart m-auto text-primary" data-bs-hover-animate="pulse"></i></div>
                        <h3>About Us</h3>
                ...
                <div class="col-lg-4">
                    <div class="mx-auto features-icons-item mb-5 mb-lg-0 mb-lg-3">
                        ...
                        <h3><strong>Quality Guaranteed</strong></h3>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 my-auto h-100 text-center text-lg-left">
                    ...
                    <p class="text-muted small mb-4 mb-lg-0">© MiniWatch 2021</p>
                </div>
    ...
    <script id="bs-live-reload" data-sseport="53908" data-lastchange="1615919331479" src="/js/livereload.js"></script>
</body>
